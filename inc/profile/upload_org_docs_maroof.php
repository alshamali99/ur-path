...
$doc_num=strip_tags($_POST['maroof_num']);

$allowedExtensions = ['jpg', 'jpeg', 'png', 'gif', 'pdf'];
$maxFileSize = 20 * 1024 * 1024; // 20MB

if (isset($_FILES['upload_maroof'])) {
    $file = $_FILES['upload_maroof'];
    ...
    */
    if (move_uploaded_file($fileTmpName, $fileDestination)) {
        ...
        mysqli_query($conn,"DELETE from org_docs where u_id=".$user_l['id']." AND doc_type='maroof' ") or die("Er-doc-del");
        $work_file=strip_tags($_POST['upload_maroof']);
        $f_type="maroof";
